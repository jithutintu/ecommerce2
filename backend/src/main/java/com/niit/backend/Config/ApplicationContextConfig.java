...
import com.niit.backend.DAO.QueriesDaoImpl;
	...
	private Properties getHibernateProperties(){
		...
		return properties;
		    ...
		    public SessionFactory getSessionFactory(DataSource dataSource) {
		    	...
		    	sessionBuilder.addAnnotatedClasses(Queries.class);
...
@Autowired(required=true)
@Bean(name="queriesDao")
public QueriesDao getQueriesDao(SessionFactory sessionFactory){
	return new QueriesDaoImpl( sessionFactory );
}
